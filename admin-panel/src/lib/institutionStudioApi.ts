...
export const institutionStudioApi = {
  ...
  studioGroups: () => request<any[]>("/v1/campus/institution/studio/groups"),
  ...
  studioOpportunities: () => request<any[]>("/v1/campus/institution/studio/opportunities"),
  ...
  studioPlaces: () => request<any[]>("/v1/campus/institution/studio/places"),
