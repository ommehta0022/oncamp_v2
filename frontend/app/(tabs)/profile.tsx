      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 120 }} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.profileHeader}>
          <View style={{ marginTop: -50, alignSelf: "flex-start" }}>
            <Avatar uri={currentUser.avatar} name={currentUser.name} size={100} verified={currentUser.verified} />
          </View>
        ...
        <View style={{ paddingHorizontal: spacing.lg, marginTop: spacing.md }}>
          ...
          <View style={{ flexDirection: "row", gap: spacing.lg, marginTop: spacing.md, flexWrap: "wrap" }}>
            <MetaRow icon="school-outline" text={currentUser.institution} />
            <MetaRow icon="location-outline" text={currentUser.city} />
          </View>
